...
parser.add_argument('--save_images', '-s', action=argparse.BooleanOptionalAction, default=True)
parser.add_argument('--print_log', '-l', action=argparse.BooleanOptionalAction, default=True)
...
print(vis.detect_dumping_zone(image, True))
